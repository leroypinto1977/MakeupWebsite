  ...
  const processSteps = [
    {
      ...
      duration: "30 minutes",
      description: "We discuss your vision, wedding theme, and personal style preferences to create the perfect look.",
      details: [
    ...
    },
    {
      ...
      title: "Trial Session",
      duration: "2-3 hours",
      description: "Complete makeup trial to perfect your bridal look and make any necessary adjustments.",
      details: [
    ...
    },
    {
      ...
      description: "Final preparations including skincare routine and last-minute adjustments if needed.",
      details: [
    ...
    },
    {
      ...
      title: "Wedding Day",
      duration: "3-4 hours",
      description: "Your special day! Professional makeup application with touch-ups throughout the ceremony.",
      details: [
    ...
    },
    {
      ...
      title: "Post-Wedding",
      duration: "Follow-up",
      description: "We follow up to ensure you were completely satisfied and provide aftercare tips.",
      details: [
    ...
    <div ref={timelineRef} className="space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-muted-foreground font-body max-w-2xl mx-auto">
          From initial consultation to your wedding day, we guide you through every step to ensure you look absolutely stunning.
        </p>
      </div>
      {/* Timeline */}
          ...
          {processSteps?.map((step, index) => (
            ...
            >
              ...
              <div className="absolute left-4 md:left-1/2 w-8 h-8 bg-primary rounded-full flex items-center justify-center md:transform md:-translate-x-1/2 z-10">
                <Icon name={step?.icon} size={16} color="var(--color-primary-foreground)" />
              </div>
      ...
      <div className="text-center pt-8">
        <div className="bg-gradient-to-r from-primary/10 via-accent/20 to-primary/10 rounded-2xl p-8">
          ...
          <p className="text-muted-foreground font-body mb-4">
            Book your free consultation today and let's create your perfect bridal look together.
          </p>
