  ...
  useEffect(() => {
    ...
    if (!prefersReducedMotion) {
      ...
      tl.to(image, { opacity: 1, y: 0, duration: 0.8, ease: "power2.out" })
        .to(content, { opacity: 1, y: 0, duration: 0.8, ease: "power2.out" }, "-=0.4");
    }
  }, []);

  return (
    <section ref={heroRef} className="relative min-h-[70vh] lg:min-h-[80vh] flex items-center bg-gradient-to-br from-background via-card to-accent overflow-hidden">
      {/* Background Pattern */}
          ...
          <div ref={contentRef} className="space-y-6 lg:space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg lg:text-xl text-muted-foreground font-body leading-relaxed max-w-xl">
                Transform your special day with our comprehensive bridal makeup packages. From trial sessions to your wedding day, we ensure you look absolutely radiant.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-6 pt-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-muted-foreground">5.0 (200+ reviews)</span>
              </div>
